...
const buttonClasses =
  "flex items-center justify-center w-full bg-neutral-900 p-2 rounded-lg transition-colors duration-200 hover:[filter:brightness(1.15)] cursor-pointer border border-neutral-800 shadow-[inset_2px_2px_8px_0_rgba(255,255,255,0.08),inset_-2px_-2px_8px_0_rgba(0,0,0,0.25)] space-x-2";

const disabledButtonClasses =
  "flex items-center justify-center w-full bg-neutral-900 p-2 rounded-lg border border-neutral-800 shadow-[inset_2px_2px_8px_0_rgba(255,255,255,0.08),inset_-2px_-2px_8px_0_rgba(0,0,0,0.25)] space-x-2 opacity-50 cursor-not-allowed";
